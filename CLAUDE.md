# Kombu Web Design - Portfolio Website

## Overview
Single-page portfolio website for Kombu Web Design (Ryan's web design business). Dark theme with terracotta/orange accents, GSAP scroll animations, and responsive design. Anti-agency positioning: personal service, fast turnaround, no gouging for simple changes.
...
### Sections
1. **Loader** - "Kombu / Web Design" two-tone reveal with terracotta progress bar
...
4. **About** - Split layout with profile photo + bio + stat badges + kombu metaphor + anti-agency copy
...
8. **FAQ** - Accordion with CSS + JS toggle (includes agency comparison FAQ)
...
- **Primary domain**: https://kombu.uk
- **Legacy domain**: https://stanikk.com (301 redirects to kombu.uk)
...
- **Email**: design@kombu.uk (forwards to photography@ryanstanikk.co.uk via Cloudflare Email Routing)
- **Phone**: +442381112819
